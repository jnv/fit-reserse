...
![Moodle; dostupnost a pojetí výchozích bloků se v každém systému liší.](img/moodle_1.png)
...
|
|--------------------|---------------------------------------------------------------------------------------------------------|
| Web projektu       | <https://moodle.org/>                                                                                   |
| Organizace         | [Moodle HQ](http://moodle.com/)                                                                         |
| Platforma          | PHP                                                                                                     |
| Aktivní od         | 2002 (1.0) [1999]                                                                                       |
| Zdrojové kódy      | <http://git.moodle.org/>                                                                                |
| Příklady nasazení  | řada univerzit i SŠ v ČR, [další](http://moodle.com/stories/), [statistiky](https://moodle.org/stats/)  |
...
![Moodle – dashboard studenta s přizpůsobitelnými „widgety.“](img/moodle_2.png)

![Moodle – ukázka modulů v kurzu; moduly jsou hierarchicky rozdělené do volitelných sekcí a mohou mít vzájemné závislosti. Student si může odškrtnout absolvované moduly.](img/moodle_3.png)

![Moodle – správa hodnocení studentů; hodnocení je udělované na základě výsledků z jednotlivých modulů.](img/moodle_4.png)

![Moodle – mobilní aplikace Moodle Mobile.](img/moodle_5.png)
...
|
|--------------------|------------------------------------------------------------------------------------------------------------|
| Web projektu       | <http://www.sakaiproject.org/>                                                                             |
| Organizace         | [Apareo](http://www.apereo.org/)                                                                           |
| Platforma          | Java (Spring)                                                                                              |
| Aktivní od         | 2005                                                                                                       |
| Zdrojové kódy      | <https://source.sakaiproject.org/svn/>                                                                     |
| Příklady nasazení  | přes 300 univerzit i soukromých organizací, zejm. v USA ([seznam](http://www.sakaiproject.org/community))  |
...
![Sakai – přidávání modulu do „lekce.“](img/sakai_1.png)

![Sakai – sylabus předmětu s přílohami; funguje nezávisle na „lekcích.“*](img/sakai_2.png)

![Sakai – přidávání otázky do kvízu.](img/sakai_3.png)
...
|
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Web projektu       | <http://www.instructure.com/>                                                                                                                               |
| Organizace         | [Instructure](http://www.instructure.com/)                                                                                                                  |
| Platforma          | Ruby (Rails)                                                                                                                                                |
| Aktivní od         | ~2008                                                                                                                                                       |
| Zdrojové kódy      | [github.com/instructure/canvas-lms](https://github.com/instructure/canvas-lms)                                                                              |
| Příklady nasazení  | kolem 300 univerzit a středních škol ([K-12](http://www.instructure.com/k-12/stories)) v USA ([více](http://www.instructure.com/higher-education/stories))  |
...
![Canvas – marketingová infografika. [[zdroj](http://www.instructure.com/higher-education/)]](img/canvas_1.png)
...
![Canvas – pohled studenta na moduly v předmětu.](img/canvas_2.png)

![Canvas – známkování studentů.](img/canvas_3.png)

![Canvas – collaborations; vytváření sdíleného dokumentu pod Google Docs.](img/canvas_4.png)

![Canvas – kalendář předmětu; i papírové testy mají vazbu na známkovací systém, případně je možné je opravovat elektronicky.](img/canvas_4.png)

![Canvas – přidávání kvízu.](img/canvas_5.png)
...
|
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Web projektu       | <http://code.edx.org/>                                                                                                                                                                      |
| Organizace         | [xConsortium](https://www.edx.org/schools-partners) (zejm. Stanford, UC Berkley, MIT, Harvard aj.)                                                                                                                |
| Platforma          | Python (Django)                                                                                                                                                                                                   |
| Aktivní od         | 2012 (HarvardX, open-source od června 2013)                                                                                                                                                                       |
| Zdrojové kódy      | [github.com/edx](https://github.com/edx/)                                                                                                                                                                |
| Příklady nasazení  | [edX](https://www.edx.org/), [Stanford Online](https://class.stanford.edu/), [UZH testuje interní nasazení](http://www.edx.uzh.ch/) ([více](https://github.com/edx/edx-platform/wiki/Sites-powered-by-Open-edX))  |

edX je mezi uvedenými systémy velice specifický – jako jediný byl od základu navržen pro masivní on-line kurzy (MOOC) s cílem zpřístupnit výuku na předních univerzitách veřejnosti. Svým způsobem se jedná o masové distanční vzdělávání – přednášky jsou nahrazené nahranými videi a hodnocení je automatické, případně si hodnotí studenti navzájem (Peer Assassment). edX je tedy primárně určený pro asynchronní výuku a velkou zátěž (tisíce studentů v jednom kurzu není neobvyklé).
...
![edX – správa jednotek kurzu.](img/edx_1.png)

![edX – úprava dílčí jednotky.](img/edx_2.png)

![edX – nastavení známkování.](img/edx_3.png)

![edX – zobrazení sekcí a jednotek v kurzu.](img/edx_4.png)
